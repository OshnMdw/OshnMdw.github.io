...
const data = [
  {
    ...
    details: 'This is the portfolio website you are looking at right now.Technologies: React JS, HTML, CSS'
  },
  {
    id: 2,
    image: IMG2,
    ...
    details: 'This job board app allows users to search and apply for jobs. Users can search for jobs by keyword, location, or job type, and display a list of jobs with titles, companies, and short descriptions. Then they can view more details or apply for the job... #Technologies: ReactJS, Node JS'
  },
  {
    id: 3,
    image: IMG3,
    ...
    details: 'It is an innovative online learning web application and mobile application designed to revolutionize the process of preparing for driving license tests in Sri Lanka. It includes instructional videos, interactive quizzes, video-based quizzes, and specialized exercises for recognizing road signs... #Technologies: ReactJS, React-Native, Node.js, MongoDB, ExpressJS, AWS'
  },
  {
    id: 4,
    image: IMG7,
    ...
    details: 'TalkTogether is an innovative mobile app designed to bridge language barriers by providing real-time translation for voice calls... #Technologies: Flutter, Dart, Firebase, Node JS'
  },
  {
    id: 5,
    image: IMG5,
  ...
  },
  {
    ...
    details: 'This is a social platform for all the Leos from around Sri Lanka to publish their work with the community... #Technologies: Flutter, Dart, Java, Firebase, Node.js... #Awards: - Most Innovative Project - Best Project Organized on behalf of the Leo Multiple District'
  },
]
